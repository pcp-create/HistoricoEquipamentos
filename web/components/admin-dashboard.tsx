          ...
          <>
            <section className="manual-card">
              ...
              <p className="muted">
                ...
                mantém as funções operacionais do sistema. O e-mail identifica o
                funcionário e seu login. Funcionários bloqueados não recebem
                alertas.
              </p>
              <form onSubmit={save}>
              ...
              {editing && (
                <fieldset disabled={busy}>
                  ...
                  <p>
                    Para quem ainda não possui login, salve o cadastro e crie a
                    conta com uma senha inicial. Contas existentes continuam
                  ...
                  <button
                    type="button"
                    disabled={
                      !data.loginProvisioningConfigured || password.length < 12
                    }
                    onClick={createLogin}
                  >

...
async function main() {
  ...
  try {
    ...
    for (const name of ['001_m8_history.sql', '002_m8_observed_types.sql', '003_m8_id_scan.sql', '004_m8_approval_mixed.sql', '005_m8_collection_cycle.sql', '006_m8_product_stock.sql', '007_m8_product_lookup.sql', '008_m8_equipment_registry.sql', '009_m8_equipment_link_safety.sql', '010_m8_service_catalog.sql']) {

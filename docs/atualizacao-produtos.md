...
- Estoques: monitoram produtos que aparecem no histórico de OS, inclusive excluídos; não gastam chamadas detalhadas com todo o catálogo sem aplicação. Novos produtos do histórico entram automaticamente após a importação do cadastro.
